...
def diff(r1, r2):
    ...
    #subtract r2 from r1 and return the resulting rectangular prisms. if r2 and r1 do not intersect, return r1
    if r1[0] > r2[1] or r1[1] < r2[0] or \
       r1[2] > r2[3] or r1[3] < r2[2] or \
       r1[4] > r2[5] or r1[5] < r2[4]:
           return set([r1])

    rects = set()
    if r2[0] > r1[0]:
        rects.add((r1[0], r2[0] - 1,
                    r1[2], r1[3],
                    r1[4], r1[5]))

    if r2[1] < r1[1]:
        rects.add((r2[1] + 1, r1[1],
                   r1[2], r1[3],
                   r1[4], r1[5]))

    if r2[2] > r1[2]:
        rects.add((max(r1[0],r2[0]), min(r1[1],r2[1]),
                   r1[2], r2[2] - 1,
                   r1[4], r1[5]))
...
if __name__ == "__main__":
    ...
    for line in data:
        ...
        for rect in rects:
            newrects |= diff(rect,r)

        rects = newrects

    print(sum(map(size, rects)))
