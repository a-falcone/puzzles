...
if __name__ == "__main__":
    ...
    for line in data:
        ...
        elif (line[0][0] > line[1][0] and line[0][1] > line[1][1]) or (line[0][0] < line[1][0] and line[0][1] < line[1][1]):
            for i in range(maxx - minx + 1):
                field[(minx+i,miny+i)] = field.get((minx+i,miny+i),0) + 1
        else:
            for i in range(maxx - minx + 1):
                field[(minx+i,maxy-i)] = field.get((minx+i,maxy-i),0) + 1
